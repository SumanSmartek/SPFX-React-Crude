...
import styles from './LibraryCrude.module.scss';
import { ILibraryCrudeProps } from './ILibraryCrudeProps';
import { escape } from '@microsoft/sp-lodash-subset';
import { PrimaryButton } from 'office-ui-fabric-react';
import {sp} from '@pnp/sp/presets/all'

export default class LibraryCrude extends React.Component<ILibraryCrudeProps, any> {
  ...
  public bindSavedEnclouserUploadedFiles () {
    ...
    public onSubmit () {
      ...
      var Folderpath = this.props.webURL+'/MyDoc'; //[sp.web.lists.getByTitle('MyDoc')].join("/");
      for(let index = 0;index<this.state.EnclouserUploadedFiles.length;index++){
        const element = this.state.EnclouserUploadedFiles[index];
  ...
  public render(): React.ReactElement<ILibraryCrudeProps> {
